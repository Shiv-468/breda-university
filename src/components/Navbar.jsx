...
import Oval from '../assets/images/webp/Oval.png';
          ...
          <div className="flex items-center gap-[19.7px]">
            ...
            <div className="flex items-center gap-[8.8px]">
                          ...
                          <div className=" flex flex-col ">
                                <p className=' text-xsm font-bold font-Plus-Jakarta text-blue leading-[17.4px]'>Willem Beekhuis</p>
                                <p className=' text-light-blue text-xxs font-medium font-Plus-Jakarta leading-[17.7px]'>Student</p>
                            </div>
                          </div>
                            <div onClick={handleMenuToggle} className={`${isMenuOpen ? "menu" : "" } z-50 lg:hidden`}>
